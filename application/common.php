...
//    $str='<script type="text/javascript" src="../../js/jquery-3.6.0.js"></script> <script type="text/javascript" src="../../layer-v3.4.0/layer/layer.js"></script>';//加载jquery和layer
//    $str.='<script>
//    $(function(){
...
function alert($msg='',$url='',$icon='',$time=3){
    $str='<script type="text/javascript" src="../../js/jquery-3.6.0.js"></script>
    <script type="text/javascript" src="../../layer-v3.4.0/layer/layer.js"></script>';//加载jquery和layer
    $str.='<script>$(function(){
